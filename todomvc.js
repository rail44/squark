...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    const __imports = {
        env: {
            ...
            "__extjs_453480a233a21af3b3c9714e1c61a5a513374bfc": function($0) {
                return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof FocusEvent) | 0;
            },
            ...
            "__extjs_1c7f96ad52e7e5b3635a769395b56d837b850359": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){($1)[($2)]= undefined})());
            },
            ...
            "__extjs_49bb060f28a2d83ee61afa0a7e5cad450c8258d0": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). childNodes ;})());
            },
            ...
            "__extjs_7449381a90c29a095a2923f17a39d4bb7487fefe": function($0, $1, $2, $3) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);Module.STDWEB_PRIVATE.from_js($0, (function(){($1)[($2)]= ($3)})());
            },
            ...
            "__extjs_a2b16af65ac827473a87874794e6d61f99e2f317": function($0) {
            ...
            "__extjs_7ef3612f54f58af0714890b7d88f6808788e105f": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){try {let array = new Uint8Array (($1)); window.crypto.getRandomValues (array); HEAPU8.set (array , ($2)); return {success : true};}catch (err){return {success : false , error : err};}})());
            },
            ...
            "__extjs_b5ba2145a32b6f45ae364016fa112490907066d0": function($0, $1, $2) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);var self = ($0); var event_type = ($1); var listener = ($2); listener.drop (); self.removeEventListener (event_type , listener);
            },
